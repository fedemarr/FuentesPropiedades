...
async function seedConfiguracion(): Promise<void> {
  await prisma.configuracion.upsert({
    ...
    create: {
      ...
      textoNosotros:
        "Soy {{PENDIENTE}}, martillera pública matriculada (C.S.M. 0000), especializada en zona norte del Gran Buenos Aires. Trabajo de forma personalizada en cada operación de venta, alquiler y administración de propiedades, acompañando a cada cliente desde la primera consulta hasta la firma. Cubro San Miguel, Bella Vista, Muñiz, Los Polvorines, Del Viso, Tortuguitas y alrededores.",
      textoAdmin:
